...
class RatesAdapter extends ListAdapter<Coin, RatesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.price.setText(NumberFormat.getCurrencyInstance(Locale.US).format(coin.price()));
        //holder.binding.price.setText(NumberFormat.getCurrencyInstance().format(coin.price()));
